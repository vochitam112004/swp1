...
namespace WebSmokingSupport.Controllers
{
    ...
    public class MemberProfileController : ControllerBase
    {
        ...
        public async Task<IActionResult> UpdateMemberProfile(int memberId, [FromBody] DTOMemberProfileForRead memberProfileDto)
        {
            ...
            existingMemberProfile.QuitAttempts = memberProfileDto.QuitAttempts;
            existingMemberProfile.ExperienceLevel = memberProfileDto.experience_level;
