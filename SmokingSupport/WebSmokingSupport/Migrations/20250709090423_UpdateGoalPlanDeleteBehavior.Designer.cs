...
namespace WebSmokingSupport.Migrations
{
    ...
    [Migration("20250709090423_UpdateGoalPlanDeleteBehavior")]
    partial class UpdateGoalPlanDeleteBehavior
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebSmokingSupport.Entity.GoalPlan", b =>
                {
                    b.HasOne("WebSmokingSupport.Entity.MemberProfile", "Member")
                        .WithOne("GoalPlan")
                        .HasForeignKey("WebSmokingSupport.Entity.GoalPlan", "MemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("FK__GoalPlan__member__300424B4");

                    b.HasOne("WebSmokingSupport.Entity.MemberProfile", null)
                        .WithMany("GoalPlans")
