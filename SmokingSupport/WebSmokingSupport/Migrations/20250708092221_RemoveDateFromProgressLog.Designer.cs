...
namespace WebSmokingSupport.Migrations
{
    ...
    [Migration("20250708092221_RemoveDateFromProgressLog")]
    partial class RemoveDateFromProgressLog
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebSmokingSupport.Entity.AdminProfile", b =>
                {
                    ...
                    b.HasKey("AdminId")
                        .HasName("PK__AdminPro__43AA4141CBF17DDA");
            ...
            modelBuilder.Entity("WebSmokingSupport.Entity.GoalTemplate", b =>
                {
                    ...
                    b.HasKey("TemplateId")
                        .HasName("PK__GoalTemp__BE44E07923FB669E");

                    b.ToTable("GoalTemplate", (string)null);
                });

            modelBuilder.Entity("WebSmokingSupport.Entity.MemberGoal", b =>
                {
                    ...
                    b.HasKey("MemberGoalId")
                        .HasName("PK__MemberGo__378ADBCECEB612BF");
            ...
            modelBuilder.Entity("WebSmokingSupport.Entity.ProgressLog", b =>
                {
                    ...
                    b.HasIndex("GoalPlanId")
                        .IsUnique()
                        .HasFilter("[GoalPlanId] IS NOT NULL");
            ...
            modelBuilder.Entity("WebSmokingSupport.Entity.UserMembershipPayment", b =>
                {
                    ...
                    b.ToTable("UserMembershipPayments");
                });

            modelBuilder.Entity("WebSmokingSupport.Entity.AdminProfile", b =>
                {
                    b.HasOne("WebSmokingSupport.Entity.User", "Admin")
                        .WithOne("AdminProfile")
                        .HasForeignKey("WebSmokingSupport.Entity.AdminProfile", "AdminId")
                        .IsRequired()
            ...
            modelBuilder.Entity("WebSmokingSupport.Entity.MemberGoal", b =>
                {
                    b.HasOne("WebSmokingSupport.Entity.GoalPlan", "Goal")
            ...
            modelBuilder.Entity("WebSmokingSupport.Entity.ProgressLog", b =>
                {
                    b.HasOne("WebSmokingSupport.Entity.GoalPlan", null)
                        .WithOne("ProgressLog")
                        .HasForeignKey("WebSmokingSupport.Entity.ProgressLog", "GoalPlanId");

                    b.HasOne("WebSmokingSupport.Entity.MemberProfile", "Member")
                        .WithOne("ProgressLog")
                        .HasForeignKey("WebSmokingSupport.Entity.ProgressLog", "MemberId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("WebSmokingSupport.Entity.UserMembershipPayment", b =>
                {
                    ...
                    b.HasOne("WebSmokingSupport.Entity.User", "User")
                        .WithMany("UserMembershipPayments")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WebSmokingSupport.Entity.User", b =>
                {
                    ...
                    b.Navigation("UserMembershipPayments");
                });
