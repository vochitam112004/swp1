...
const Community = () => {
  ...
  const motivationalQuotes = [
    "💪 Mỗi nhật ký là một bước tiến trong hành trình cai thuốc!",
    "🌟 Sự kiên trì của bạn là nguồn cảm hứng cho nhiều người!",
    "🎯 Chia sẻ câu chuyện giúp bạn và cộng đồng cùng mạnh mẽ hơn!",
    "🔥 Hành trình cai thuốc không dễ, nhưng bạn đang làm rất tốt!",
    "🌈 Mỗi ngày không thuốc lá là một chiến thắng đáng tự hào!",
    "💎 Sức khỏe của bạn đang được cải thiện từng ngày!",
    "🚀 Bạn đang trở thành phiên bản tốt nhất của chính mình!",
    "🏆 Cộng đồng tự hào về quyết tâm của bạn!"
  ];
